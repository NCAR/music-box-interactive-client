...
import {
  ...
  Paper, Select, MenuItem, FormControl, TablePagination, TableSortLabel,
  Toolbar, Typography, Checkbox, IconButton, Tooltip, TextField, Button,
  Grid
} from '@mui/material';
...
export default connect(null, { removeConditions, addCondition })(ConditionTable);