...
export default function UsageInfo() {
    ...
    const description_step5 = "Click the green 'Run Model' button to run the model with the mechanism and conditions you set in the previous steps."
    ...
    const descriptions_steps = [description_step1, description_step2, description_step3, description_step4, description_step5]
