...
export const reactionTypes = {
    ...
    emission: {
        ...
        elements: [
            ...
            {
                type: "DESCRIPTION",
                text: "Use the scaling factor to adjust emission rates from input data. " +
            ...
            {
                type: "DESCRIPTION",
                text: "Set a MUSICA name for this reaction to identify it in other parts " +
    ...
    firstOrderLoss: {
        ...
        elements: [
            ...
            {
                type: "DESCRIPTION",
                text: "Use the scaling factor to adjust first order loss rates from input data. " +
                      "A scaling factor of 1.0 results in no adjustment."
            },
            {
                type: "STRING",
    ...
    photolysis: {
        ...
        elements: [
            ...
            {
                type: "DESCRIPTION",
                text: "Use the scaling factor to adjust photolysis rates from input data. " +
                      "A scaling factor of 1.0 results in no adjustment."
            },
            {
                type: "STRING",
